# У цьому файлі визначено три функції,
# кожна з яких повинна реалізовувати різний алгоритм порівняння:
# для рядків, речень та підрядків.
